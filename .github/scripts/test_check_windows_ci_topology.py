...
class WindowsCiTopologyTests(unittest.TestCase):
    ...
    def test_windows_topology_mutations_fail_closed(self) -> None:
        ...
        cache_namespace = "windows-2025-sandbox-symbols0-cert1-"
        ...
        cases = (
            ...
            ("Windows nextest producer and consumers", 3, platform.replace("copy-windows-ci-workspace.ps1", "missing-workspace-copy.ps1", 1)),
            ...
            ("exact Windows Bazel topology", 0, bazel.replace("C:/codex-bazel-workspace", "${{ github.workspace }}", 1)),
            ("exact Windows Bazel topology", 0, bazel.replace("copy-windows-ci-workspace.ps1", "missing-workspace-copy.ps1", 1)),
            ...
            (
                ...
                bazelrc.replace(
                    ...
                    "suite::code_mode::code_mode_can_call_hidden_dynamic_tools,tests::windows_tests::conpty_ctrl_c_interrupts_powershell_foreground_child\n",
                    1,
                ),
            ),
