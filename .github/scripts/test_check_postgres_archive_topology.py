...
class PostgresArchiveTopologyTests(unittest.TestCase):
    ...
    def test_mutable_topology_invariants_fail_closed(self) -> None:
        ...
        cases = (
            ...
            ("ordinary shard JUnit path", 0, platform.replace('            "${NEXTEST_JUNIT_FILE}"\n\n      - name: Upload nextest JUnit report', '            "${CARGO_TARGET_DIR}/nextest/default/junit.xml"\n\n      - name: Upload nextest JUnit report', 1)),
